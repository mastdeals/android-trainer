...
public class Database {
    ...
    public boolean createDataBase(){
    	try {        	        		        		
    		oDatabase.execSQL("CREATE TABLE trainer_version (" +
     		...
     		oDatabase.execSQL("INSERT INTO trainer_version (id_ver, version_number, version_desc, licence) VALUES (1, '4.1', 'Ver. 4.1', 'N')");
    ...
    private boolean checkDataBase (){
    	...
    	try{
    		...
    		if(getDataBaseVersionAndLicence(checkDB)!=null){
    			...
    			if(sVersionNumber.compareToIgnoreCase("3.1")==0){
					Log.i(this.getClass().getCanonicalName(),"Upgrade DB Version From "+sVersionNumber+" TO 3.1.2");
					upgradeDB3_1To3_1_2();
				}
    			if(sVersionNumber.compareToIgnoreCase("3.1.2")==0){
					Log.i(this.getClass().getCanonicalName(),"Upgrade DB Version From "+sVersionNumber+" TO 3.1.5");
					upgradeDB3_1_2To3_1_5();
				}
    			if(sVersionNumber.compareToIgnoreCase("3.1.5")==0){
					Log.i(this.getClass().getCanonicalName(),"Upgrade DB Version From "+sVersionNumber+" TO 3.1.6");
					upgradeDB3_1_5To3_1_6();
				}
    			if(sVersionNumber.compareToIgnoreCase("3.1.6")==0){
					Log.i(this.getClass().getCanonicalName(),"Upgrade DB Version From "+sVersionNumber+" TO 3.1.7");
					upgradeDB3_1_6To3_1_7();
				}
    			if(sVersionNumber.compareToIgnoreCase("3.1.7")==0){
					Log.i(this.getClass().getCanonicalName(),"Upgrade DB Version From "+sVersionNumber+" TO 3.2");
					upgradeDB3_1_7To3_2();
				}
    			...
    			if(sVersionNumber.compareToIgnoreCase("4.0.2")==0){
					Log.i(this.getClass().getCanonicalName(),"Upgrade DB Version From "+sVersionNumber+" TO 4.1");
					upgradeDB4_0_2To4_1();
				}
    			//manualDB();
    		}
     ...
     * 
     * */
    private void upgradeDB2_6To2_7(){
    	SQLiteDatabase oDB=SQLiteDatabase.openDatabase(DB_PATH + DB_NAME, null, SQLiteDatabase.OPEN_READWRITE);
    	try{   		    	
    		oDB.execSQL("UPDATE TRAINER_CONFIG"
                    + " set cfg_value=1 WHERE "
     ...
     * 
     * */
    private void upgradeDB2_9To3_0(){
    	SQLiteDatabase oDB=SQLiteDatabase.openDatabase(DB_PATH + DB_NAME, null, SQLiteDatabase.OPEN_READWRITE);
    	try{   		    	
    		oDB.execSQL("UPDATE TRAINER_CONFIG"
                    + " set cfg_value=1 WHERE "
        	...
        	oDB.execSQL("UPDATE TRAINER_VERSION SET version_number='3.0',version_desc='Ver. 3.0'");
    	}catch (SQLException e) {
    		Log.e(this.getClass().getCanonicalName(),"Error upgrade to 3.0");
    		oDB.close();   
        	oDB=null;
        	return;
		}   	
    ...
    private void upgradeDB3_1To3_1_2(){
    	SQLiteDatabase oDB=SQLiteDatabase.openDatabase(DB_PATH + DB_NAME, null, SQLiteDatabase.OPEN_READWRITE);
    	try{   		    	
    		oDB.execSQL("UPDATE TRAINER_CONFIG"
                    + " set cfg_value=1 WHERE "
        	...
        	oDB.execSQL("UPDATE TRAINER_VERSION SET version_number='3.1.2',version_desc='Ver. 3.1.2'");
        	
    	}catch (SQLException e) {
    		Log.e(this.getClass().getCanonicalName(),"Error upgrade to 3.1.2");
    		oDB.close();   
        	oDB=null;
        	return;
		}   	
    ...
    private void upgradeDB3_1_2To3_1_5(){
    	SQLiteDatabase oDB=SQLiteDatabase.openDatabase(DB_PATH + DB_NAME, null, SQLiteDatabase.OPEN_READWRITE);
    	try{   		    	
    		oDB.execSQL("UPDATE TRAINER_CONFIG"
                    + " set cfg_value=1 WHERE "
        	...
        	oDB.execSQL("UPDATE TRAINER_VERSION SET version_number='3.1.5',version_desc='Ver. 3.1.5'");
        	
    	}catch (SQLException e) {
    		Log.e(this.getClass().getCanonicalName(),"Error upgrade to 3.1.5");
    		oDB.close();   
        	oDB=null;
        	return;
		}   	
    ...
    private void upgradeDB3_1_5To3_1_6(){
    	SQLiteDatabase oDB=SQLiteDatabase.openDatabase(DB_PATH + DB_NAME, null, SQLiteDatabase.OPEN_READWRITE);
    	try{   		    	
    		oDB.execSQL("UPDATE TRAINER_CONFIG"
                    + " set cfg_value=1 WHERE "
        	...
        	oDB.execSQL("UPDATE TRAINER_VERSION SET version_number='3.1.6',version_desc='Ver. 3.1.6'");
        	
    	}catch (SQLException e) {
    		Log.e(this.getClass().getCanonicalName(),"Error upgrade to 3.1.6");
    		oDB.close();   
        	oDB=null;
        	return;
		}   	
    ...
    private void upgradeDB3_1_6To3_1_7(){
    	SQLiteDatabase oDB=SQLiteDatabase.openDatabase(DB_PATH + DB_NAME, null, SQLiteDatabase.OPEN_READWRITE);
    	try{   		    	
    		oDB.execSQL("UPDATE TRAINER_CONFIG"
                    + " set cfg_value=1 WHERE "
        	...
        	oDB.execSQL("UPDATE TRAINER_VERSION SET version_number='3.1.7',version_desc='Ver. 3.1.7'");
        	
    	}catch (SQLException e) {
    		Log.e(this.getClass().getCanonicalName(),"Error upgrade to 3.1.7");
    		oDB.close();   
        	oDB=null;
        	return;
		}   	
    ...
    private void upgradeDB3_1_7To3_2(){
    	SQLiteDatabase oDB=SQLiteDatabase.openDatabase(DB_PATH + DB_NAME, null, SQLiteDatabase.OPEN_READWRITE);
    	try{   		    	
    		oDB.execSQL("UPDATE TRAINER_CONFIG"
                    + " set cfg_value=1 WHERE "
        	...
        	oDB.execSQL("UPDATE TRAINER_VERSION SET version_number='3.2',version_desc='Ver. 3.2'");
        	
    	}catch (SQLException e) {
    		Log.e(this.getClass().getCanonicalName(),"Error upgrade to 3.2");
    		oDB.close();   
        	oDB=null;
        	return;
		}   	
    ...
    private void upgradeDB3_2To4_0(){
    	SQLiteDatabase oDB=SQLiteDatabase.openDatabase(DB_PATH + DB_NAME, null, SQLiteDatabase.OPEN_READWRITE);
    	try{   		    	
    		oDB.execSQL("UPDATE TRAINER_CONFIG"
                    + " set cfg_value=1 WHERE "
    ...
    private void upgradeDB4_0_2To4_1(){
    	SQLiteDatabase oDB=SQLiteDatabase.openDatabase(DB_PATH + DB_NAME, null, SQLiteDatabase.OPEN_READWRITE);
    	try{   		    	
    		oDB.execSQL("UPDATE TRAINER_CONFIG"
                    + " set cfg_value=1 WHERE "
        	...
        	oDB.execSQL("UPDATE TRAINER_VERSION SET version_number='4.1',version_desc='Ver. 4.1'");
        	
    	}catch (SQLException e) {
    		Log.e(this.getClass().getCanonicalName(),"Error upgrade to 4.1");
    		oDB.close();   
        	oDB=null;
        	return;
		}   	
