...
public class TrainerPrefActivityGroup extends ActivityGroup{	
	 
	public static TrainerPrefActivityGroup group; 
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		.startActivity("PrefActivity", new
				Intent(this, PrefActivity.class)
